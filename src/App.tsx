  ...
  const loadPublicData = async () => {
    ...
    try {
      ...
      const loadedSettings: SiteSettings = {
        ...
        contact_phone: settingsRes.contact_phone || '',
        contact_email: settingsRes.contact_email || '',
        whatsapp_number: settingsRes.whatsapp_number || settingsRes.contact_phone || '',
  ...
  const handleRefreshSettings = async () => {
    ...
    if (s) {
      ...
      setSettings({
        ...
        whatsapp_number: s.whatsapp_number || s.contact_phone || '',
        address: s.address || '',
